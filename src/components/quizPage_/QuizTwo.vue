        ...
        <v-tabs v-model="active" color="teal lighten-1" dark slider-color="yellow">
            ...
            <v-tab-item v-for="n in 7" :key="n">
                    <v-card v-if="n<7" flat>
                        ...
                        <v-card-text v-if="n>=2">
                            ...
                            <div class="exampleUp mx-3 py-5 mb-4">
                                ...
                                <span class="example px-4 pb-2 pt-5 mt-3">{{ questions }}</span>
                            </div>
                        </v-card-text>
                    ...
                    <v-card-actions>
                        ...
                        <v-btn v-if="1<n&&n<6" color="red lighten-1" flat="flat" v-on:click="next(), getWorng(), checkAns()">
                            <div class="buttonClick">NEXT</div>
                        </v-btn>
                        <v-btn v-if="n==1" color="red lighten-1" flat="flat" v-on:click="next(),getWorng()">
...
export default {
    ...
    methods: {
        ...mapActions(['quest_post_actions','quest_wrong_actions']),
        next() {
        ...
        getWorng() {
            ...
            this.quest_wrong_actions(this.ran_box).then(result => {
                const back = result;
                ...
                console.log('wrong error', this.ran_box);
            }).catch(error => {
                console.log('wrong quest error', error);
            });
        },
        postQuest() {
