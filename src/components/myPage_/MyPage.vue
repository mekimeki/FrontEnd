            ...
            <v-list-tile-avatar size="180">
                ...
                <v-card-title primary-title>
                    <div class="ml-3">
                        <div>SOMIN1234</div>
                        <div>
                            <span>{{$t('myPage')['channelPerson']}}</span>
                            <span>568</span>
                        </div>
                        <div></div>
                    </div>
        ...
        <v-flex pt-3 white xs12 sm12 md12>
            <template>
                <v-tabs color="white" icons-and-text>
                    <v-tabs-slider color="#82B1FF"></v-tabs-slider>
                    <v-tab href="#tab-1">{{$t('myPage')['video']}}</v-tab>
                    <v-tab href="#tab-2">{{$t('myPage')['score']}}</v-tab>
                    <v-tab href="#tab-3">{{$t('myPage')['attend']}}</v-tab>
                    <v-tab href="#tab-4">{{$t('myPage')['privacy']}}</v-tab>
